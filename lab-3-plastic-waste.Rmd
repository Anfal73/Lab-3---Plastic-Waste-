...
```
Answer: Africa is the most density continent and the South America is the most continent in plastic waste per cap .
...
ggplot(data = plastic_waste,
     ...
     geom_point()
```
Answer: Europe (Positive) relationship, Africa is the most (mismanaged_plastic_waste_per_cap) 
